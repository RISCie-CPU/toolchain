...
Point triangle_vertex[] = {{INT2FIXED(0), INT2FIXED(0), INT2FIXED(1)}, {INT2FIXED(50), INT2FIXED(0), INT2FIXED(1)}, {INT2FIXED(50), INT2FIXED(50), INT2FIXED(1)}, {INT2FIXED(-80), INT2FIXED(70), INT2FIXED(1)}};
...
int main(void)
{
    ...
    draw_object_2D(&triangle_vertex[0], sizeof(triangle_vertex), &MATRIX_NORMALX);
